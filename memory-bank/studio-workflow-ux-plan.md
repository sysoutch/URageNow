...
- The current home is an intermediate implementation, not approved completion. It has direct workflow choices and real generation history, but still carries the duplicated Chat/recent-content model and proportion problems described above.
